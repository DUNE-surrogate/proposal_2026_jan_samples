...
nevt=100
model=hn_esf
prefix=prodaddgenie_nnbar_${model}_dune10kt_1x2x6_hf_train_etau_3alpha_2beta_2
...
ifdh cp /pnfs/dune/persistent/users/sungbino/surrogate/sample_prod/2026_jan_proposal/hf_train/standard_g4_dune10kt_1x2x6_etau_3alpha_2beta_2.fcl $CONDOR_DIR_INPUT
ifdh cp	/pnfs/dune/persistent/users/sungbino/surrogate/sample_prod/2026_jan_proposal/hf_train/standard_detsim_dune10kt_1x2x6_etau_3alpha_2beta_2.fcl $CONDOR_DIR_INPUT
...
lar -c standard_detsim_dune10kt_1x2x6_etau_3alpha_2beta_2.fcl -n $nevt -s ${prefix}_G4_${jobid}.root -o ${prefix}_G4_detsim_${jobid}.root
ls -ltrha
...
ifdh cp -D ${prefix}_G4_detsim_reco1_reco2_anahist_${jobid}.root /pnfs/dune/scratch/users/sungbino/v09_85_00/nnbar/${model}/hf_train/etau_3alpha_2beta_2/anahist/

ifdh cp -D ${prefix}_G4_detsim_reco1_reco2_${jobid}.root /pnfs/dune/scratch/users/sungbino/v09_85_00/nnbar/${model}/hf_train/etau_3alpha_2beta_2/reco2/

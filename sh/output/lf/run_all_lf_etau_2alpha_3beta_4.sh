...
nevt=100
model=hn_esf
prefix=prodaddgenie_nnbar_${model}_dune10kt_1x2x6_lf_etau_2alpha_3beta_4
...
ifdh cp /pnfs/dune/persistent/users/sungbino/surrogate/sample_prod/2026_jan_proposal/lf/standard_g4_dune10kt_1x2x6_etau_2alpha_3beta_4.fcl $CONDOR_DIR_INPUT
ifdh cp	/pnfs/dune/persistent/users/sungbino/surrogate/sample_prod/2026_jan_proposal/lf/standard_detsim_dune10kt_1x2x6_etau_2alpha_3beta_4.fcl $CONDOR_DIR_INPUT
...
ifdh cp -D ${prefix}_G4_detsim_reco1_reco2_anahist_${jobid}.root /pnfs/dune/scratch/users/sungbino/v09_85_00/nnbar/${model}/lf/etau_2alpha_3beta_4/anahist/

ifdh cp -D ${prefix}_G4_detsim_reco1_reco2_${jobid}.root /pnfs/dune/scratch/users/sungbino/v09_85_00/nnbar/${model}/lf/etau_2alpha_3beta_4/reco2/

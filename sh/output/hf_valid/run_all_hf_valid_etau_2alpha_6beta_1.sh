...
nevt=100
model=hn_esf
prefix=prodaddgenie_nnbar_${model}_dune10kt_1x2x6_hf_valid_etau_2alpha_6beta_1
...
ifdh cp /pnfs/dune/persistent/users/sungbino/surrogate/sample_prod/2026_jan_proposal/hf_valid/standard_g4_dune10kt_1x2x6_etau_2alpha_6beta_1.fcl $CONDOR_DIR_INPUT
ifdh cp	/pnfs/dune/persistent/users/sungbino/surrogate/sample_prod/2026_jan_proposal/hf_valid/standard_detsim_dune10kt_1x2x6_etau_2alpha_6beta_1.fcl $CONDOR_DIR_INPUT
echo "again ls-ing within CONDOR_DIR_INPUT at $CONDOR_DIR_INPUT"
ls -ltrha

lar -c standard_g4_dune10kt_1x2x6_etau_2alpha_6beta_1.fcl -s ${genie_file} -n $nevt -o ${prefix}_G4_${jobid}.root
echo "finally ls-ing within CONDOR_DIR_INPUT at $CONDOR_DIR_INPUT"
ls -ltrha

lar -c standard_detsim_dune10kt_1x2x6_etau_2alpha_6beta_1.fcl -n $nevt -s ${prefix}_G4_${jobid}.root -o ${prefix}_G4_detsim_${jobid}.root
ls -ltrha
...
ifdh cp -D ${prefix}_G4_detsim_reco1_reco2_anahist_${jobid}.root /pnfs/dune/scratch/users/sungbino/v09_85_00/nnbar/${model}/hf_valid/etau_2alpha_6beta_1/anahist/

ifdh cp -D ${prefix}_G4_detsim_reco1_reco2_${jobid}.root /pnfs/dune/scratch/users/sungbino/v09_85_00/nnbar/${model}/hf_valid/etau_2alpha_6beta_1/reco2/

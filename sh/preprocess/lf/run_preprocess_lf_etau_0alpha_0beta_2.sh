...
ifdh cp /pnfs/dune/scratch/users/sungbino/v09_85_00/nnbar/${model}/lf/etau_0alpha_0beta_2/reco2/${input} $CONDOR_DIR_INPUT
...
ifdh cp -D *preprocess.root /pnfs/dune/scratch/users/sungbino/v10_03_01/nnbar//${model}/lf/etau_0alpha_0beta_2/preprocess
ifdh cp -D RecoEnergyS.root /pnfs/dune/scratch/users/sungbino/v10_03_01/nnbar//${model}/lf/etau_0alpha_0beta_2/preprocess/${prefix}_G4_detsim_reco1_reco2_RecoEnergyS_$jobid.root
